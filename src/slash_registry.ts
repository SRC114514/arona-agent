...
export const SLASH_COMMANDS: SlashCommandSpec[] = [
  ...
  { name: "change-agent", description: t("切换主 Agent + 多选子 Agent（桌宠形象 / 同屏 / 轮询回复）", "Switch main agent + multi-select sub agents (pet / same-screen / poll replies)"), interactive: true },
